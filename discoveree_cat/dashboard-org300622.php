...
$value=$value_array[$key][trim($value)]['org_value'];
    ...
    $value=trim(str_replace("\n","",str_replace("\r","",str_replace("\t","",trim($value)))));
     if($key=="package" || ($key!="features" && $key!="user_id" && $key!="fixingtime_min" && $key!="searchword" && strlen($key)>=2 && substr($key, -2)!="tc" && substr($key, -3)!="tc1" && substr($key, -3)!="tc2"  && substr($key, -3)!="tc3"  && substr($key, -3)!="tc4" && strpos($value,"=")===false && strpos($value,",")===false && strpos($value,";")===false)){

     if(strpos($key,'discoveree_')!==false)
     $vvv=trim($value);
     else
     $vvv=trim(manflabel($value));
...
?>
<option <? if((strpos($v['input_type'],"dropdownm")!==false && $getdefaultsearch[0]=="" && ($dfm==0 || $default_manf[$dd_val]==1 || $default_manf_lower[strtolower(str_replace(" ","",$dd_val))]==1 || substr($v['fieldname'],0,strlen($v['fieldname'])-1)!="manf")) || strpos($getdefaultsearch[0],$datavalue)!==false){?>SELECTED<?}?> value="<?=$datavalue;?>"><?=$dd_val;?></option>
<?
}
...
var color = Chart.helpers.color;
	var scatterChartData = {
        ...
        $legend_count=0;
        foreach($data as $k=>$v){
        if($dashboard_setting['legend']!="manf" || ($dashboard_setting['legend']=="manf" && ($dfm==0 || $default_manf[$k]==1 || $default_manf_lower[strtolower(str_replace(" ","",$k))]==1))){
        $legend_count++;
        $lk=str_replace(" ","-",$k);
        ?>
        {
...
if($clr==1)
return "063a51"; //063a51
else if($clr==2)
return "c13119"; //c13119
else if($clr==3)
return "f36f14"; //f36f14
else if($clr==4)
return "ebcb39";  //ebcb39
else if($clr==5)
return "a3b969";  //a3b969
else if($clr==6)
return "0d96bc";  //0d96bc
else if($clr==7)
return "455054";  //0d96bc
else if($clr==8)
return "d45769";  //0d96bc
else if($clr==9)
return "663845";  //0d96bc
else if($clr==10)
return "4a707a";  //0d96bc
else if($clr==11)
return "ebaa10";  //0d96bc
else if($clr==12)
return "dd4470";  //0d96bc
else if($clr==13)
return "45b19b";  //0d96bc
else if($clr==14)
return "3d3264";  //0d96bc
else if($clr==15)
return "336b3e";  //0d96bc
else if($clr==16)
return "4f3663";  //0d96bc
else if($clr==17)
return "a35d15";  //0d96bc
else if($clr==18)
return "ff6600";  //0d96bc
else if($clr==19)
return "b91b4b";  //0d96bc
else if($clr==20)
return "fbde6a";  //0d96bc
else
